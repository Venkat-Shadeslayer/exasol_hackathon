...
NCERT_CHAPTER_FILE = "leph103.pdf"


def load_real_ncert_chunks(directory: str, filename: str) -> list[dict]:
    """Real chunks parsed from the actual NCERT Class 12 Physics Current Electricity chapter."""
    records = [
        record
...
REQUEST = (
    "I am a Class 12 student. I understand Ohm's law and resistors in series and parallel but "
    "do not understand Kirchhoff's voltage law and Kirchhoff's current law. Explain Kirchhoff's "
    "voltage law and Kirchhoff's current law at NCERT Class 12 level with circuit examples. "
...
async def main() -> None:
    ...
    project_id = f"kirchhoff-{uuid4().hex[:8]}"
